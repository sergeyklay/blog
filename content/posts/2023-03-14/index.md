...
Весьма неплохо, 1.09 против 29.66 --- в 29 раз быстрее. Разумеется, какое-то время в Python пришлись на трансляцию кода, но оно не столь значимо в данном примере. Реализацию теста и сравнение скомпилированной Python-версии оставлю в качестве домашнего задания, однако предупреждаю, ничего революционного вы там не увидите, прирост по времени будет не значительный.
